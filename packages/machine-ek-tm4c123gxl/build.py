...
def system_build(system):
    ...
    c_flags = common_flags + ['-O2', '-DTARGET_IS_TM4C123_RB1', '-DPART_TM4C123GH6PM', '-Dgcc']
    ...
    for c, o in zip(system.c_files, c_obj_files):
        ...
        execute(['arm-none-eabi-gcc', '-ffreestanding', '-c', c, '-o', o, '-Wall', '-fdata-sections', '-fno-common', '-fno-zero-initialized-in-bss'] +
